...
export default function Header() {
    ...
    return(
        <header className=' flex justify-center p-4' >
          ...
          <form onSubmit={handleSearchSubmit} className='flex items-center border border-green-800 rounded-full  px-2'>
                <input
                    type="text"
                    value={searchQuery}
                    onChange={handleSearchChange}
                    placeholder="Search here......"
                    className='flex-grow outline-none border-none px-2'
                />
                <button type="submit" className='flex items-center gap-1 border border-green-800 rounded-full py-2 px-2 text-green-200 bg bg-green-800'>
       ...
       <Link to="/cart" className='padding-left: px-20 '>
